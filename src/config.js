...
const config = {
  ...
  DEIP_TENANT: process.env.DEIP_TENANT ? JSON.parse(process.env.DEIP_TENANT) : null,
  DEIP_TENANT_PORTAL: process.env.DEIP_TENANT_PORTAL ? JSON.parse(process.env.DEIP_TENANT_PORTAL) : null,
